# Contributing to fetch-to-markdown

First and foremost, thank you! We appreciate that you want to contribute to fetch-to-markdown, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for fetch-to-markdown**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for fetch-to-markdown:

- star the [project](https://github.com/HoukasaurusRex/fetch-to-markdown#readme)
- tweet your support for fetch-to-markdown
...
- **version**: (required) please note the version of fetch-to-markdown are you using
...
The original poster or the maintainers of fetch-to-markdown may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/fetch-to-markdown
